...
// NewHandler builds the handler backed by the given event store.
func NewHandler(store *Store) *Handler {
	return &Handler{store: store}
}

// Mount registers event routes on r. Reads require a valid Clerk JWT; writes
// require exec or admin.
